...
from models.user import EditableOrder, EditableFlowerBase, FlowerBase, OrderBase, FlowersInOrderBase
...
from models.user import EditableUserBase, UserBase, EditableFlowersInOrder
from utils.partial import optional


@optional
class CreateFlsInOrdr(FlowersInOrderBase):
    pass


@optional
class UpdateFlsInOrdr(EditableFlowersInOrder):
    pass
...
@optional
class UpdateOrderReq(EditableOrder):
    pass


class CreateOrderReq(OrderBase):
    pass


class CreateFlowerReq(FlowerBase):
    pass


@optional
class UpdateFlowerReq(EditableFlowerBase):
    pass
